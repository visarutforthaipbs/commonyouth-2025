  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden py-20 lg:py-32 px-4">
        ...
        <div className="absolute top-10 right-0 w-64 h-64 bg-brand-bud/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute bottom-0 left-10 w-72 h-72 bg-brand-ocean/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-64 bg-brand-orange/5 rotate-12 blur-3xl -z-10"></div>

        <div className="container mx-auto text-center relative z-10">
          <span className="inline-block py-1 px-3 rounded-full bg-brand-morning/40 text-brand-obsidian text-xs font-bold uppercase tracking-wider mb-6 border border-brand-obsidian/20">
            พื้นที่พลังพลเมือง
          </span>
          <h1 className="text-5xl md:text-7xl font-bold text-brand-obsidian mb-6 leading-tight">
            ...
            ร่วมสร้าง <span className="relative inline-block">
              พื้นที่กลาง
              <svg className="absolute w-full h-3 -bottom-1 left-0 text-brand-orange" viewBox="0 0 200 9" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.00025 6.99997C2.00025 6.99997 82.4992 1.00007 99.9999 1.99997C117.5 2.99987 198 7.00007 198 7.00007" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/></svg>
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-brand-earth mb-10 max-w-2xl mx-auto">
            เชื่อมต่อกับกลุ่มเยาวชน ค้นหากิจกรรม และแสดงพลังของคนรุ่นใหม่ทั่วประเทศไทย
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              onClick={() => navigate('/map')}
              className="px-8 py-4 bg-brand-obsidian text-brand-linen rounded-xl font-bold text-lg shadow-retro hover:translate-y-1 hover:shadow-none transition-all flex items-center justify-center border-2 border-brand-obsidian"
            >
              สำรวจแผนที่ <MapPin className="ml-2 w-5 h-5" />
            </button>
            <button 
              onClick={() => navigate('/community')}
              className="px-8 py-4 bg-brand-linen border-2 border-brand-obsidian text-brand-obsidian rounded-xl font-bold text-lg hover:bg-brand-bud transition-all flex items-center justify-center"
            >
      ...
      <section className="bg-brand-obsidian text-brand-linen py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/20">
            <div className="p-2">
              <div className="text-4xl font-bold text-brand-bud mb-1">200+</div>
            ...
            <div className="p-2">
              <div className="text-4xl font-bold text-brand-mist mb-1">12</div>
      ...
      <section className="py-20 bg-brand-mist/20 border-y border-brand-ocean/10">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            ...
            <button onClick={() => navigate('/community')} className="text-brand-bud font-bold hover:underline flex items-center">
